...
class ChinaSpider(CrawlSpider):
    ...
    # 定义提取URL的规则
    rules = (
        Rule(LinkExtractor(allow='article\/.*\.html', restrict_xpaths='//div[@id="left_side"]//div[@class="con_item"]/div[@class="conR"]/h2/a'), callback='parse_item'),
